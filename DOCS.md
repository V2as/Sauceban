...
Интерактивное обновление или смена версии Xray-core. Показывает список доступных версий и позволяет выбрать нужную.

```bash
marzban core-update
```

> **Примечание:** Интерактивная команда — покажет меню выбора версии.
